...
public class HomegrownBlocks {
    ...
    public static void init(){
		// Post Blocks
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"oak_planks_post"), OAK_PLANKS_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"oak_log_post"), OAK_LOG_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_oak_log_post"), STRIPPED_OAK_LOG_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"oak_wood_post"), OAK_WOOD_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_oak_wood_post"), STRIPPED_OAK_WOOD_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"spruce_planks_post"), SPRUCE_PLANKS_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"spruce_log_post"), SPRUCE_LOG_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_spruce_log_post"), STRIPPED_SPRUCE_LOG_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"spruce_wood_post"), SPRUCE_WOOD_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_spruce_wood_post"), STRIPPED_SPRUCE_WOOD_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"birch_planks_post"), BIRCH_PLANKS_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"birch_log_post"), BIRCH_LOG_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_birch_log_post"), STRIPPED_BIRCH_LOG_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"birch_wood_post"), BIRCH_WOOD_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_birch_wood_post"), STRIPPED_BIRCH_WOOD_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"jungle_planks_post"), JUNGLE_PLANKS_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"jungle_log_post"), JUNGLE_LOG_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_jungle_log_post"), STRIPPED_JUNGLE_LOG_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"jungle_wood_post"), JUNGLE_WOOD_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_jungle_wood_post"), STRIPPED_JUNGLE_WOOD_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"acacia_planks_post"), ACACIA_PLANKS_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"acacia_log_post"), ACACIA_LOG_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_acacia_log_post"), STRIPPED_ACACIA_LOG_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"acacia_wood_post"), ACACIA_WOOD_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_acacia_wood_post"), STRIPPED_ACACIA_WOOD_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"dark_oak_planks_post"), DARK_OAK_PLANKS_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"dark_oak_log_post"), DARK_OAK_LOG_POST);
		...
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"crimson_hyphae_post"), CRIMSON_HYPHAE_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_crimson_hyphae_post"), STRIPPED_CRIMSON_HYPHAE_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"warped_planks_post"), WARPED_PLANKS_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"warped_stem_post"), WARPED_STEM_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_warped_stem_post"), STRIPPED_WARPED_STEM_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"warped_hyphae_post"), WARPED_HYPHAE_POST);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"stripped_warped_hyphae_post"), STRIPPED_WARPED_HYPHAE_POST);
		// Crop Blocks
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"tomato"), TOMATO);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"corn"), CORN);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"rice"), RICE);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"wild_rice"), WILD_RICE);
		Registry.register(Registries.BLOCK, new Identifier(MOD_ID,"burning_bush"), BURNING_BUSH);
