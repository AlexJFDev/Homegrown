...
public class HomegrownItems {
	...
	public static final Item OAK_PLANKS_POST = new BlockItem(HomegrownBlocks.OAK_PLANKS_POST, new Item.Settings());
	public static final Item OAK_LOG_POST = new BlockItem(HomegrownBlocks.OAK_LOG_POST, new Item.Settings());
	public static final Item STRIPPED_OAK_LOG_POST = new BlockItem(HomegrownBlocks.STRIPPED_OAK_LOG_POST, new Item.Settings());
	public static final Item OAK_WOOD_POST = new BlockItem(HomegrownBlocks.OAK_WOOD_POST, new Item.Settings());
	public static final Item STRIPPED_OAK_WOOD_POST = new BlockItem(HomegrownBlocks.STRIPPED_OAK_WOOD_POST, new Item.Settings());
	public static final Item SPRUCE_PLANKS_POST = new BlockItem(HomegrownBlocks.SPRUCE_PLANKS_POST, new Item.Settings());
	public static final Item SPRUCE_LOG_POST = new BlockItem(HomegrownBlocks.SPRUCE_LOG_POST, new Item.Settings());
	public static final Item STRIPPED_SPRUCE_LOG_POST = new BlockItem(HomegrownBlocks.STRIPPED_SPRUCE_LOG_POST, new Item.Settings());
	public static final Item SPRUCE_WOOD_POST = new BlockItem(HomegrownBlocks.SPRUCE_WOOD_POST, new Item.Settings());
	public static final Item STRIPPED_SPRUCE_WOOD_POST = new BlockItem(HomegrownBlocks.STRIPPED_SPRUCE_WOOD_POST, new Item.Settings());
	public static final Item BIRCH_PLANKS_POST = new BlockItem(HomegrownBlocks.BIRCH_PLANKS_POST, new Item.Settings());
	public static final Item BIRCH_LOG_POST = new BlockItem(HomegrownBlocks.BIRCH_LOG_POST, new Item.Settings());
	public static final Item STRIPPED_BIRCH_LOG_POST = new BlockItem(HomegrownBlocks.STRIPPED_BIRCH_LOG_POST, new Item.Settings());
	public static final Item BIRCH_WOOD_POST = new BlockItem(HomegrownBlocks.BIRCH_WOOD_POST, new Item.Settings());
	public static final Item STRIPPED_BIRCH_WOOD_POST = new BlockItem(HomegrownBlocks.STRIPPED_BIRCH_WOOD_POST, new Item.Settings());
	public static final Item JUNGLE_PLANKS_POST = new BlockItem(HomegrownBlocks.JUNGLE_PLANKS_POST, new Item.Settings());
	public static final Item JUNGLE_LOG_POST = new BlockItem(HomegrownBlocks.JUNGLE_LOG_POST, new Item.Settings());
	public static final Item STRIPPED_JUNGLE_LOG_POST = new BlockItem(HomegrownBlocks.STRIPPED_JUNGLE_LOG_POST, new Item.Settings());
	public static final Item JUNGLE_WOOD_POST = new BlockItem(HomegrownBlocks.JUNGLE_WOOD_POST, new Item.Settings());
	public static final Item STRIPPED_JUNGLE_WOOD_POST = new BlockItem(HomegrownBlocks.STRIPPED_JUNGLE_WOOD_POST, new Item.Settings());
	public static final Item ACACIA_PLANKS_POST = new BlockItem(HomegrownBlocks.ACACIA_PLANKS_POST, new Item.Settings());
	public static final Item ACACIA_LOG_POST = new BlockItem(HomegrownBlocks.ACACIA_LOG_POST, new Item.Settings());
	public static final Item STRIPPED_ACACIA_LOG_POST = new BlockItem(HomegrownBlocks.STRIPPED_ACACIA_LOG_POST, new Item.Settings());
	public static final Item ACACIA_WOOD_POST = new BlockItem(HomegrownBlocks.ACACIA_WOOD_POST, new Item.Settings());
	public static final Item STRIPPED_ACACIA_WOOD_POST = new BlockItem(HomegrownBlocks.STRIPPED_ACACIA_WOOD_POST, new Item.Settings());
	public static final Item DARK_OAK_PLANKS_POST = new BlockItem(HomegrownBlocks.DARK_OAK_PLANKS_POST, new Item.Settings());
	public static final Item DARK_OAK_LOG_POST = new BlockItem(HomegrownBlocks.DARK_OAK_LOG_POST, new Item.Settings());
	public static final Item STRIPPED_DARK_OAK_LOG_POST = new BlockItem(HomegrownBlocks.STRIPPED_DARK_OAK_LOG_POST, new Item.Settings());
	public static final Item DARK_OAK_WOOD_POST = new BlockItem(HomegrownBlocks.DARK_OAK_WOOD_POST, new Item.Settings());
	public static final Item STRIPPED_DARK_OAK_WOOD_POST = new BlockItem(HomegrownBlocks.STRIPPED_DARK_OAK_WOOD_POST, new Item.Settings());
	public static final Item MANGROVE_PLANKS_POST = new BlockItem(HomegrownBlocks.MANGROVE_PLANKS_POST, new Item.Settings());
	public static final Item MANGROVE_LOG_POST = new BlockItem(HomegrownBlocks.MANGROVE_LOG_POST, new Item.Settings());
	public static final Item STRIPPED_MANGROVE_LOG_POST = new BlockItem(HomegrownBlocks.STRIPPED_MANGROVE_LOG_POST, new Item.Settings());
	public static final Item MANGROVE_WOOD_POST = new BlockItem(HomegrownBlocks.MANGROVE_WOOD_POST, new Item.Settings());
	public static final Item STRIPPED_MANGROVE_WOOD_POST = new BlockItem(HomegrownBlocks.STRIPPED_MANGROVE_WOOD_POST, new Item.Settings());
	public static final Item CRIMSON_PLANKS_POST = new BlockItem(HomegrownBlocks.CRIMSON_PLANKS_POST, new Item.Settings());
	public static final Item CRIMSON_STEM_POST = new BlockItem(HomegrownBlocks.CRIMSON_STEM_POST, new Item.Settings());
	public static final Item STRIPPED_CRIMSON_STEM_POST = new BlockItem(HomegrownBlocks.STRIPPED_CRIMSON_STEM_POST, new Item.Settings());
	public static final Item CRIMSON_HYPHAE_POST = new BlockItem(HomegrownBlocks.CRIMSON_HYPHAE_POST, new Item.Settings());
	public static final Item STRIPPED_CRIMSON_HYPHAE_POST = new BlockItem(HomegrownBlocks.STRIPPED_CRIMSON_HYPHAE_POST, new Item.Settings());
	public static final Item WARPED_PLANKS_POST = new BlockItem(HomegrownBlocks.WARPED_PLANKS_POST, new Item.Settings());
	public static final Item WARPED_STEM_POST = new BlockItem(HomegrownBlocks.WARPED_STEM_POST, new Item.Settings());
	public static final Item STRIPPED_WARPED_STEM_POST = new BlockItem(HomegrownBlocks.STRIPPED_WARPED_STEM_POST, new Item.Settings());
	public static final Item WARPED_HYPHAE_POST = new BlockItem(HomegrownBlocks.WARPED_HYPHAE_POST, new Item.Settings());
	public static final Item STRIPPED_WARPED_HYPHAE_POST = new BlockItem(HomegrownBlocks.STRIPPED_WARPED_HYPHAE_POST, new Item.Settings());
	
	public static final Item BURNING_BALE = new BlockItem(HomegrownBlocks.BURNING_BALE, new Item.Settings());
	public static final Item CANTALOUPE_BLOCK = new BlockItem(HomegrownBlocks.CANTALOUPE_BLOCK, new Item.Settings());
	
	public static final Item RED_TOMATO = new Item(new Item.Settings().food(HomegrownFoodComponents.RED_TOMATO));
	public static final Item GREEN_TOMATO = new Item(new Item.Settings().food(HomegrownFoodComponents.GREEN_TOMATO));
	public static final Item TOMATO_SEEDS = new PostCropSeeds(HomegrownBlocks.TOMATO, new Item.Settings());
	public static final Item CORN_EAR = new Item(new Item.Settings().food(HomegrownFoodComponents.CORN_EAR));
	...
	public static final Item BURNING_BUDS = new Item(new Item.Settings());
	public static final Item CANTALOUPE_SLICE = new Item(new Item.Settings().food(HomegrownFoodComponents.CANTALOUPE_SLICE));
